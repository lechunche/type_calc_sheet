...
require_once($CFG->dirroot . '/question/type/type_calc_sheet/question.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_type_calc_sheet_question_test extends advanced_testcase {
    public function test_compare_string_with_wildcard() {
        // Test case sensitive literal matches.
        $this->assertTrue((bool)qtype_type_calc_sheet_question::compare_string_with_wildcard(
                'Frog', 'Frog', false));
        $this->assertFalse((bool)qtype_type_calc_sheet_question::compare_string_with_wildcard(
                'Frog', 'frog', false));
        $this->assertTrue((bool)qtype_type_calc_sheet_question::compare_string_with_wildcard(
                '   Frog   ', 'Frog', false));
        $this->assertFalse((bool)qtype_type_calc_sheet_question::compare_string_with_wildcard(
    ...
    public function test_is_complete_response() {
        $question = test_question_maker::make_question('type_calc_sheet');
    ...
    public function test_get_correct_response_escapedwildcards() {
        $question = test_question_maker::make_question('type_calc_sheet', 'escapedwildcards');

        $this->assertEquals(array('answer' => 'x*y'), $question->get_correct_response());
    }

    public function test_get_question_summary() {
        $sa = test_question_maker::make_question('type_calc_sheet');
    ...
    public function test_classify_response_no_star() {
        $sa = test_question_maker::make_question('type_calc_sheet', 'frogonly');
        $sa->start_attempt(new question_attempt_step(), 1);
