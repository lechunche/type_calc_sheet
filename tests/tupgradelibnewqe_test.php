...
/**
 * Testing the upgrade of type_calc_sheet question attempts.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_type_calc_sheet_attempt_upgrader_test extends question_attempt_upgrader_test_base {

    public function test_type_calc_sheet_deferredfeedback_history620() {
        $quiz = (object) array(
            'id' => '221',
            'course' => '187',
 ...
 <p>Ignore all sunk costs, ignore all ______ costs, use remaining costs for decision making purposes. </p>',
    ...
    public function test_type_calc_sheet_deferredfeedback_history60() {
        $quiz = (object) array(
            'id' => '789',
            'course' => '3500',
    ...
    public function test_type_calc_sheet_deferredfeedback_history3220() {
        $quiz = (object) array(
            'id' => '221',
            'course' => '187',
            'name' => 'Practice CTMA04',
